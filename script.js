            ...
            messages: [
              {
                role: "user",
                content:
                  "give me suggestions on what to plant considering that the average temperature range in my area during the growing season is " +
                  q_1 +
                  ", the rainfall our region gets is about " +
                  q_2 +
                  " and the crops that we previously planted was " +
                  q_3 +
                  " knowing that the crops that are currently in high demand in our local market is " +
                  q_4 +
                  " The retention of moisture of my soil is " +
                  q_5 +
                  " and the altitude of my farming location is " +
                  q_6,
              },
            ],
